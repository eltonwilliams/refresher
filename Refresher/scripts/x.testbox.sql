...
go
update branch_process_control set run_time_schedule = 'Minute1', is_active = 1 where process_name in ('Send New Switched Branch Txns to Central', 'Fetch New Switched Branch Txns From Central', 'Send Modified Switched Branch Txns to Central', 'Process Switched Branch Txn at Branch', 'Fetch Modified Switched Branch Txns From Central')
go
